...
public:
    ...
    void fromEuler(double rol, double pit, double yaw) {
        double bank=rol*PI/180;
        double attitude=pit*PI/180;
        double heading=yaw*PI/180;
    ...
    Vector<3> toEuler() const
    {
        ...
        //ret.y() = atan2(2.0*(_x*_z+_y*_w),(sqx-sqy+sqz-sqw));
